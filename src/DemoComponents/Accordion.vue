<template>
  <div>
    <u>Box style & Compact</u>

    <br />

    <button class="vs-button vs-button__primary-fill vs-button--small" @click="setIndex">Toggle Accordion</button>
    ...
    <u>Single bordered style & Individual Expandable</u>
...
<script>
  import VsAccordion from '../../packages/vs-accordion/src/vs-accordion.vue';
  import VsAccordionItem from '../../packages/vs-accordion/src/vs-accordion-item.vue';
  export default {
    name: 'App',
    components: { VsAccordion, VsAccordionItem },
    data() {

(function (global, factory) {
  ...
  (global = global || self, factory(global.VsDatepicker = {}));
  ...
  function getValidDate(value) {
    ...
    for (var _len = arguments.length, backup = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      backup[_key - 1] = arguments$1[_key];
    }
  ...
  function mergeDeep(target, source) {
    ...
    if (isObject(source)) {
      Object.keys(source).forEach(function (key) {
        ...
        result = _objectSpread2({}, result, _defineProperty$1({}, key, value));
      });
    }
  ...
  var CalendarPanel = {
    ...
    render: function render() {
      ...
      return h(__vue_component__$4, {
        "class": _defineProperty$1({}, "".concat(this.prefixClass, "-calendar-week-mode"), this.type === 'week'),
        "attrs": {
          "calendar": innerCalendar,
  ...
  var DatePicker = {
    ...
    render: function render() {
      ...
      return h("div", {
        "class": (_class = {}, _defineProperty$1(_class, "".concat(prefixClass, "-datepicker"), true), _defineProperty$1(_class, "".concat(prefixClass, "-datepicker-range"), this.range), _defineProperty$1(_class, "".concat(prefixClass, "-datepicker-inline"), inline), _defineProperty$1(_class, "disabled", disabled), _class)
  ...
  var script$9 = {
    ...
    methods: {
      ...
      emitOpen: function emitOpen(value) {
        this.$emit('open', value);
      },

      emitClose: function emitClose(value) {
  ...
  var __vue_render__$b = function() {
    ...
    return _c(
      ...
      [
        _c("label", { staticClass: "vs-datepicker__label" }, [
          _c("span", [_vm._v(_vm._s(_vm.label))]),
          _vm._v(" "),
          _vm.required
            ? _c("span", { staticClass: "vs-datepicker--required" }, [
                _vm._v(" *")
              ])
            : _vm._e()
        ]),
  ...
  __vue_render__$b._withStripped = true;
    ...
    var __vue_inject_styles__$b = function (inject) {
      if (!inject) { return }
      inject("data-v-2ad5a82c_0", { source: ".vs-icon-left:before,\n.vs-icon-right:before,\n.vs-icon-double-left:before,\n.vs-icon-double-right:before,\n.vs-icon-double-left:after,\n.vs-icon-double-right:after {\n  content: \"\";\n  position: relative;\n  top: -1px;\n  display: inline-block;\n  width: 10px;\n  height: 10px;\n  vertical-align: middle;\n  border-style: solid;\n  border-color: currentColor;\n  border-width: 2px 0 0 2px;\n  border-radius: 1px;\n  box-sizing: border-box;\n  transform-origin: center;\n  transform: rotate(-45deg) scale(0.7);\n}\n.vs-icon-double-left:after {\n  left: -4px;\n}\n.vs-icon-double-right:before {\n  left: 4px;\n}\n.vs-icon-right:before,\n.vs-icon-double-right:before,\n.vs-icon-double-right:after {\n  transform: rotate(135deg) scale(0.7);\n}\n.vs-btn {\n  box-sizing: border-box;\n  line-height: 1;\n  font-size: 14px;\n  font-weight: 500;\n  padding: 7px 15px;\n  margin: 0;\n  cursor: pointer;\n  background-color: transparent;\n  outline: none;\n  border: 1px solid rgba(0, 0, 0, 0.1);\n  border-radius: 4px;\n  color: #555;\n  white-space: nowrap;\n}\n.vs-btn:hover {\n  border-color: #1f73b7;\n  color: #1f73b7;\n}\n.vs-btn-text {\n  border: 0;\n  padding: 0 4px;\n  text-align: left;\n  line-height: inherit;\n}\n.vs-scrollbar {\n  height: 100%;\n}\n.vs-scrollbar:hover .vs-scrollbar-track {\n  opacity: 1;\n}\n.vs-scrollbar-wrap {\n  height: 100%;\n  overflow-x: hidden;\n  overflow-y: auto;\n}\n.vs-scrollbar-track {\n  position: absolute;\n  top: 2px;\n  right: 2px;\n  bottom: 2px;\n  width: 6px;\n  z-index: 1;\n  border-radius: 4px;\n  opacity: 0;\n  transition: opacity 0.24s ease-out;\n}\n.vs-scrollbar-track .vs-scrollbar-thumb {\n  position: absolute;\n  width: 100%;\n  height: 0;\n  cursor: pointer;\n  border-radius: inherit;\n  background-color: rgba(144, 147, 153, 0.3);\n  transition: background-color 0.3s;\n}\n.vs-zoom-in-down-enter-active,\n.vs-zoom-in-down-leave-active {\n  opacity: 1;\n  transform: scaleY(1);\n  transition: transform 0.3s cubic-bezier(0.23, 1, 0.32, 1), opacity 0.3s cubic-bezier(0.23, 1, 0.32, 1);\n  transform-origin: center top;\n}\n.vs-zoom-in-down-enter,\n.vs-zoom-in-down-leave-to {\n  opacity: 0;\n  transform: scaleY(0);\n}\n.vs-datepicker {\n  position: relative;\n  display: inline-block;\n  width: 210px;\n}\n.vs-datepicker svg {\n  width: 1em;\n  height: 1em;\n  vertical-align: -0.15em;\n  fill: currentColor;\n  overflow: hidden;\n}\n.vs-datepicker-range {\n  width: 320px;\n}\n.vs-datepicker-inline {\n  width: auto;\n}\n.vs-input-wrapper {\n  position: relative;\n}\n.vs-input-wrapper .vs-icon-clear {\n  display: none;\n}\n.vs-input-wrapper:hover .vs-icon-clear {\n  display: block;\n}\n.vs-input-wrapper:hover .vs-icon-clear + .vs-icon-calendar {\n  display: none;\n}\n.vs-input {\n  display: inline-block;\n  box-sizing: border-box;\n  width: 100%;\n  height: 34px;\n  padding: 6px 30px;\n  padding-left: 10px;\n  font-size: 14px;\n  line-height: 1.4;\n  color: #555;\n  background-color: #fff;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);\n}\n.vs-input:hover, .vs-input:focus {\n  border-color: #409aff;\n}\n.vs-input:disabled, .vs-input.disabled {\n  color: #ccc;\n  background-color: #f3f3f3;\n  border-color: #ccc;\n  cursor: not-allowed;\n}\n.vs-input:focus {\n  outline: none;\n}\n.vs-input::-ms-clear {\n  display: none;\n}\n.vs-icon-calendar,\n.vs-icon-clear {\n  position: absolute;\n  top: 50%;\n  right: 8px;\n  transform: translateY(-50%);\n  font-size: 16px;\n  line-height: 1;\n  color: rgba(0, 0, 0, 0.5);\n  vertical-align: middle;\n}\n.vs-icon-clear {\n  cursor: pointer;\n}\n.vs-icon-clear:hover {\n  color: rgba(0, 0, 0, 0.8);\n}\n.vs-datepicker-main {\n  font: 14px/1.5 \"Helvetica Neue\", Helvetica, Arial, \"Microsoft Yahei\", sans-serif;\n  color: #555;\n  background-color: #fff;\n  border: 1px solid #e8e8e8;\n}\n.vs-datepicker-popup {\n  position: absolute;\n  margin-top: 1px;\n  margin-bottom: 1px;\n  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.175);\n  z-index: 2001;\n}\n.vs-datepicker-sidebar {\n  float: left;\n  box-sizing: border-box;\n  width: 100px;\n  padding: 6px;\n  overflow: auto;\n}\n.vs-datepicker-sidebar + .vs-datepicker-content {\n  margin-left: 100px;\n  border-left: 1px solid #e8e8e8;\n}\n.vs-datepicker-body {\n  position: relative;\n  user-select: none;\n}\n.vs-btn-shortcut {\n  display: block;\n  padding: 0 6px;\n  line-height: 24px;\n}\n.vs-range-wrapper {\n  display: flex;\n}\n@media (max-width: 750px) {\n.vs-range-wrapper {\n    flex-direction: column;\n}\n}\n.vs-datepicker-header {\n  padding: 6px 8px;\n  border-bottom: 1px solid #e8e8e8;\n}\n.vs-datepicker-footer {\n  padding: 6px 8px;\n  text-align: right;\n  border-top: 1px solid #e8e8e8;\n}\n.vs-calendar {\n  box-sizing: border-box;\n  width: 248px;\n  padding: 6px 12px;\n}\n.vs-calendar + .vs-calendar {\n  border-left: 1px solid #e8e8e8;\n}\n.vs-calendar-header, .vs-time-header {\n  box-sizing: border-box;\n  height: 34px;\n  line-height: 34px;\n  text-align: center;\n  overflow: hidden;\n}\n.vs-btn-icon-left,\n.vs-btn-icon-double-left {\n  float: left;\n}\n.vs-btn-icon-right,\n.vs-btn-icon-double-right {\n  float: right;\n}\n.vs-calendar-header-label {\n  font-size: 14px;\n}\n.vs-calendar-decade-separator {\n  margin: 0 2px;\n}\n.vs-calendar-decade-separator:after {\n  content: \"~\";\n}\n.vs-calendar-content {\n  position: relative;\n  height: 224px;\n  box-sizing: border-box;\n}\n.vs-calendar-content .cell {\n  cursor: pointer;\n}\n.vs-calendar-content .cell:hover {\n  color: #555;\n  background-color: #f4f8fb;\n}\n.vs-calendar-content .cell.active {\n  color: #fff;\n  background-color: #1f73b7;\n}\n.vs-calendar-content .cell.in-range, .vs-calendar-content .cell.hover-in-range {\n  color: #555;\n  background-color: #ddeaf4;\n}\n.vs-calendar-content .cell.disabled {\n  cursor: not-allowed;\n  color: #ccc;\n  background-color: #f3f3f3;\n}\n.vs-calendar-week-mode .vs-date-row {\n  cursor: pointer;\n}\n.vs-calendar-week-mode .vs-date-row:hover {\n  background-color: #f4f8fb;\n}\n.vs-calendar-week-mode .vs-date-row.vs-active-week {\n  background-color: #ddeaf4;\n}\n.vs-calendar-week-mode .vs-date-row .cell:hover {\n  color: inherit;\n  background-color: transparent;\n}\n.vs-calendar-week-mode .vs-date-row .cell.active {\n  color: inherit;\n  background-color: transparent;\n}\n.vs-week-number {\n  opacity: 0.5;\n}\n.vs-table {\n  table-layout: fixed;\n  border-collapse: separate;\n  border-spacing: 0;\n  width: 100%;\n  height: 100%;\n  box-sizing: border-box;\n  text-align: center;\n  vertical-align: middle;\n}\n.vs-table th {\n  padding: 0;\n  font-weight: 500;\n}\n.vs-table td {\n  padding: 0;\n}\n.vs-table-date td,\n.vs-table-date th {\n  height: 32px;\n  font-size: 12px;\n}\n.vs-table-date .today {\n  color: #3581be;\n}\n.vs-table-date .cell.not-current-month {\n  color: #ccc;\n  background: none;\n}\n.vs-time {\n  flex: 1;\n  width: 224px;\n  background: #fff;\n}\n.vs-time + .vs-time {\n  border-left: 1px solid #e8e8e8;\n}\n.vs-calendar-time {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}\n.vs-time-header {\n  border-bottom: 1px solid #e8e8e8;\n}\n.vs-time-content {\n  height: 224px;\n  box-sizing: border-box;\n  overflow: hidden;\n}\n.vs-time-columns {\n  display: flex;\n  width: 100%;\n  height: 100%;\n  overflow: hidden;\n}\n.vs-time-column {\n  flex: 1;\n  position: relative;\n  border-left: 1px solid #e8e8e8;\n  text-align: center;\n}\n.vs-time-column:first-child {\n  border-left: 0;\n}\n.vs-time-column .vs-time-list {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n}\n.vs-time-column .vs-time-list::after {\n  content: \"\";\n  display: block;\n  height: 192px;\n}\n.vs-time-column .vs-time-item {\n  cursor: pointer;\n  font-size: 12px;\n  height: 32px;\n  line-height: 32px;\n}\n.vs-time-column .vs-time-item:hover {\n  color: #555;\n  background-color: #f4f8fb;\n}\n.vs-time-column .vs-time-item.active {\n  color: #1f73b7;\n  background-color: transparent;\n  font-weight: 700;\n}\n.vs-time-column .vs-time-item.disabled {\n  cursor: not-allowed;\n  color: #ccc;\n  background-color: #f3f3f3;\n}\n.vs-time-option {\n  cursor: pointer;\n  padding: 8px 10px;\n  font-size: 14px;\n  line-height: 20px;\n}\n.vs-time-option:hover {\n  color: #555;\n  background-color: #f4f8fb;\n}\n.vs-time-option.active {\n  color: #1f73b7;\n  background-color: transparent;\n  font-weight: 700;\n}\n.vs-time-option.disabled {\n  cursor: not-allowed;\n  color: #ccc;\n  background-color: #f3f3f3;\n}\n.vs-datepicker {\n  --primary-color: #1f73b7;\n  position: relative;\n  width: 100%;\n}\n.vs-datepicker__label {\n  line-height: 1.42857;\n  color: #2f3941;\n  font-size: 14px;\n  font-weight: 600;\n}\n.vs-datepicker__input {\n  margin-top: 8px;\n  border: 1px solid #d8dcde;\n  border-radius: 4px;\n  width: 100%;\n  box-sizing: border-box;\n  vertical-align: middle;\n  font-family: inherit;\n  padding: 0.714286em 0.857143em;\n  min-height: 40px;\n  line-height: 1.28571;\n  font-size: 14px;\n  background-color: #ffffff;\n  color: #2f3941;\n  transition: border-color 0.25s ease-in-out 0s, box-shadow 0.1s ease-in-out 0s, background-color 0.25s ease-in-out 0s, color 0.25s ease-in-out 0s;\n  outline: none;\n  display: flex;\n  align-items: center;\n}\n.vs-datepicker__input:hover {\n  border-color: var(--primary-color);\n}\n.vs-datepicker__input:focus {\n  border-color: var(--primary-color);\n  box-shadow: rgba(31, 115, 183, 0.35) 0px 0px 0px 3px;\n}\n.vs-datepicker__input--error {\n  border-color: #cc3340;\n}\n.vs-datepicker__input--error:hover {\n  border-color: #cc3340;\n}\n.vs-datepicker__input--error:focus {\n  border-color: #cc3340;\n  box-shadow: rgba(31, 115, 183, 0.35) 0px 0px 0px 3px;\n}\n.vs-datepicker--required {\n  color: #cc3340;\n}\n.vs-datepicker .disabled .vs-datepicker__input {\n  background: #f8f9f9;\n  color: #c2c8cc;\n  cursor: no-drop;\n  border-color: #e9ebed;\n  user-select: none;\n}\n.vs-datepicker .disabled .vs-datepicker__input:hover {\n  border-color: #e9ebed;\n}\n.vs-datepicker-main {\n  --vs-datepicker-primary-color: #1f73b7;\n  --vs-datepicker-grey: #c2c8cc;\n  --vs-datepicker-white: #ffffff;\n  --vs-datepicker-black: #333333;\n  --vs-datepicker-range-color: rgba(31, 115, 183, 0.08);\n  --vs-datepicker-font-family: system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen-Sans, Ubuntu,\n    Cantarell, Helvetica Neue, Arial, sans-serif;\n  color: var(--vs-datepicker-black);\n  font-feature-settings: \"kern\", \"kern\";\n  -webkit-font-kerning: normal;\n  font-kerning: normal;\n  font-family: var(--vs-datepicker-font-family);\n}\n.vs-datepicker-main .vs-calendar {\n  width: 275px;\n  padding: 15px 15px;\n}\n.vs-datepicker-main .vs-calendar-header, .vs-datepicker-main .vs-time-header {\n  height: 40px;\n  line-height: 30px;\n}\n.vs-datepicker-main .vs-calendar-header-label {\n  line-height: 10px;\n}\n.vs-datepicker-main .vs-calendar-content .cell {\n  color: var(--vs-datepicker-primary-color);\n}\n.vs-datepicker-main .vs-calendar-content .cell.active {\n  color: var(--vs-datepicker-white);\n}\n.vs-datepicker-main .vs-calendar-content .cell.disabled, .vs-datepicker-main .vs-calendar-content .cell.not-current-month {\n  color: var(--vs-datepicker-grey);\n  background-color: transparent;\n}\n.vs-datepicker-main .vs-calendar-content .cell.in-range {\n  background-color: var(--vs-datepicker-range-color);\n  background-color: rgba(31, 115, 183, 0.08);\n}\n.vs-datepicker-main .vs-calendar-content .vs-table th {\n  font-size: 14px;\n  font-weight: 600;\n}\n.vs-datepicker-main .vs-calendar-content .vs-table.vs-table-date td, .vs-datepicker-main .vs-calendar-content .vs-table.vs-table-date th {\n  font-size: 13px;\n}\n.vs-datepicker-main .vs-btn {\n  font-feature-settings: \"kern\", \"kern\";\n  -webkit-font-kerning: normal;\n  font-kerning: normal;\n  font-family: var(--vs-datepicker-font-family);\n  color: var(--vs-datepicker-black);\n  font-size: 14px;\n  font-weight: 600;\n}", map: undefined, media: undefined });
  ...
  function install(Vue) {
    ...
    Vue.component('VsDatepicker', __vue_component__$b);
  }
